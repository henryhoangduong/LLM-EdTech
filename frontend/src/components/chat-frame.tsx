          ...
          {messages.length === 0 ? (
            <div className='flex-1 flex flex-col items-center justify-center p-4 space-y-4 opacity-70'>
              ...
              <div className='text-center max-w-md space-y-2'>
                <h3 className='text-lg font-medium'>Welcome to BDA</h3>
            ...
            <form onSubmit={handleSubmit} className='w-full flex justify-center'>
              <div className='w-full max-w-3xl flex items-center gap-2 px-4 py-2 rounded-full bg-white shadow-lg border border-gray-100'>
                <Input
                  ...
                  disabled={isLoading}
                  className='flex-1 border-none shadow-none bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 px-2 py-1 text-base placeholder:text-gray-400'
                />
                <Button
                  type='submit'
      ...
      <AnimatePresence>
        {sourcePanelOpen && selectedMessage && (
          ...
          >
            ...
            <div className='flex-1 overflow-hidden'>{/* <SourcePanel message={selectedMessage} /> */}</div>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
