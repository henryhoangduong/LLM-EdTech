...
import { HenryDoc, Document } from '@/types/types' // Ensure SimbaDoc and Document are imported

interface PreviewModalProps {
  isOpen: boolean
  onClose: () => void
  document: HenryDoc | null
  onUpdate: (document: HenryDoc) => void
}
...
const PreviewModal: React.FC<PreviewModalProps> = ({ isOpen, onClose, document, onUpdate }) => {
  ...
  const renderFilePreview = () => {
    ...
    // const previewUrl = previewApi.getPreviewUrl(document.id)
    const previewUrl = 'https://arxiv.org/pdf/2302.13971'
    ...
    if (previewError) {
      return (
        <div className='flex flex-col items-center justify-center p-6 h-full'>
          ...
          <div className='text-gray-500 mb-4 text-sm text-center'>File path: {document.metadata.file_path}</div>
      ...
      return (
        <div className='flex flex-col items-center justify-center p-6 h-full'>
          ...
          <div className='text-gray-600 mb-6 text-center max-w-md'>
            Your browser has blocked the document preview for security reasons. You can still download or open the
    ...
    return (
      <div className='flex flex-col lg:flex-row gap-4 flex-1 overflow-hidden'>
        ...
        <Card className='flex-1 min-h-[200px]  flex flex-col overflow-hidden'>
          ...
          <CardContent className='p-0 flex-1 overflow-hidden'>{renderFilePreview()}</CardContent>
        </Card>
